...
1.	Quel est l’environnement à installer pour exécuter un script PHP ? Citer 2 exemples de logiciels permettant ce contexte
    un environement de développement universel portable, isolé, rapide et puissant, Laragon et xampp

2.	Qu’est-ce qu’un algorithme ?
    un alogrithme est une suite d'étape qui permettent d'arriver à un résultat

3.	Qu’est-ce qu’une variable ? Par quel symbole est préfixée une variable en PHP ?
c'est un espace en mémoire qui permettent d'associé une valeur et sa clé. en php on désigne une variable par "$"

4.	Qu’est-ce que la portée d’une variable ?
la portée d'une variable est la zone d'utilisation de la variable, une variable déclaré dans une fonction n'est pas utilisable en dehors de celle-ci.

5.	Qu’est-ce qu’une constante ? Quelle est la différence avec une variable ?
une constante est une variable dont la valeur est fixe et ne change pas, la différence avec une variable est que la variable peut être changé.

6.	Qu’est-ce qu’une superglobale, combien en existent-ils et donner un exemple d’utilisation
ce sont des variable disponible partout quel que soit le contexte, exemple : $_GET ou $_POST
...
## Front-end
18.	Définir HTML
language de balisage permettant de mettre en place des balise pour y définir la structure d'un site internet

19.	Définir CSS
le css vient de cascading style sheet permet la mise en forme de contenu html.
...
oui du javascript peut être interpréter côté serveur en utilisant un framework comme node.js
